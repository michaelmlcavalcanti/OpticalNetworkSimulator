...
/* 
 * File:   MaximumRegeneration.cpp
 * Author: brunovacorreia
 * 
 * Created on August 25, 2019, 11:18 PM
 */

#include "../../../include/ResourceAllocation/RegeneratorAssignment/MaximumRegeneration.h"

MaximumRegeneration::MaximumRegeneration(ResourceDeviceAlloc* resDevAlloc)
...
void MaximumRegeneration::ResourceAlloc(CallDevices* call) {
    resDevAlloc->RoutingOffVirtRegSpecAlloc(call);
}

void MaximumRegeneration::OrderRegenerationOptions(CallDevices* call, 
