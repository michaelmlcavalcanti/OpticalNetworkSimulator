...
/* 
 * File:   MinimumSlotsMaxReg.cpp
 * Author: brunovacorreia
 * 
 * Created on August 25, 2019, 10:53 PM
 */

#include "../../../include/ResourceAllocation/RegeneratorAssignment/MinimumSlotsMaxReg.h"

MinimumSlotsMaxReg::MinimumSlotsMaxReg(ResourceDeviceAlloc* resDevAlloc)
:RegeneratorAssignment(resDevAlloc) {
    
}

MinimumSlotsMaxReg::~MinimumSlotsMaxReg() {
}

void MinimumSlotsMaxReg::ResourceAlloc(CallDevices* call) {
    resDevAlloc->RoutingOffVirtRegSpecAlloc(call);
}

void MinimumSlotsMaxReg::OrderRegenerationOptions(CallDevices* call, 
