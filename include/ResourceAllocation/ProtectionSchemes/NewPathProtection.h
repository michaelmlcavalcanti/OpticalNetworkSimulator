...
public:
  ...
  */
    ...
    */
    ...
    bool RoutingCallProtectedWithThreeRoutes(CallDevices *pDevices);

    bool RoutingCallUnprotectedWithOneRoute(CallDevices *pDevices);

    void RoutingCallWithTwoRoutes(CallDevices *pDevices);
